...
function Home(props) {
    ...
    return (
        <div className="container">
            ...
            <Home_Product gender={`Male`} category={'674eb17e970c600a082a91a3'} GET_id_modal={GET_id_modal} />

            <Home_Product gender={`Female`} category={'674eb182970c600a082a91a4'} GET_id_modal={GET_id_modal} />
